<div class="wrap">
    ...
    <form action="" method="post">
        ...
        <table class="form-table">
            <tbody>
                ...
                <tr class="row-date">
                    ...
                    <td>
                        <input type="date" name="date" id="date" class="regular-text" placeholder="<?php echo esc_attr( '', 'wedevs' ); ?>" value="<?php echo esc_attr( $item->date ); ?>" required="required" />
                ...
                <tr class="row-date-due">
                    ...
                    <td>
                        <input type="date" name="date_due" id="date_due" class="regular-text" placeholder="<?php echo esc_attr( '', 'wedevs' ); ?>" value="<?php echo esc_attr( $item->date_due ); ?>" required="required" />
                ...
                <tr class="row-price">
                    ...
                    <td>
                        <input type="number" name="price" id="price" class="regular-text" placeholder="<?php echo esc_attr( '', 'wedevs' ); ?>" value="<?php echo esc_attr( $item->price ); ?>" required="required" />
                    </td>
                </tr>
                <tr class="row-ks">
                    <th scope="row">
                    ...
                    <td>
                        <input type="text" name="ks" id="ks" class="regular-text" placeholder="<?php echo esc_attr( '', 'wedevs' ); ?>" value="<?php echo esc_attr( $item->ks ); ?>" required="required" />
                    </td>
                </tr>
        ...
        <?php wp_nonce_field( '' ); ?>
        <?php submit_button( __( 'Aktualizovat', 'wedevs' ), 'primary', 'Submit' ); ?>
